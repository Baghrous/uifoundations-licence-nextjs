...
export default function StatCardIcon({
  title = 'Today',
  description = 'Over the last week, your average steps were 10,198 per day.',
  titleIcon = <TbCalendar />,
  helpTooltipText,
  value = '12,480',
  valuePrefix,
  valueSuffix = 'total',
  ...
  const valueShouldBeDeemphasized =
