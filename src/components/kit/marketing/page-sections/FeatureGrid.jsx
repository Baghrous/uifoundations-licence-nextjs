    ...
    >
      <Container maxWidth='md'>
        <Box sx={{ maxWidth: 'md', mx: 'auto', textAlign: { lg: 'center' } }}>
          ...
          >
            Our comprehensive React UI kit provides you with all the tools and
            components you need to create stunning, responsive, and accessible
            ...
            <Grid item xs={12} sm={6} key={feature.name}>
              ...
              >
                ...
                >
                  ...
                  <Typography
                    sx={{ color: 'gray.900', fontWeight: 600, fontSize: 'md' }}
                  >
                    {feature.name}
                  </Typography>
                  <Typography
